...
package com.wj.opc.examples.server;


import com.wj.opc.examples.server.methods.GenerateEventMethod;
import com.wj.opc.examples.server.methods.SqrtMethod;
import com.wj.opc.examples.server.types.CustomEnumType;
import com.wj.opc.examples.server.types.CustomStructType;
import com.wj.opc.examples.server.types.CustomUnionType;
...
public class ExampleNamespace extends ManagedNamespaceWithLifecycle {
    ...
    private void addScalarNodes(UaFolderNode rootNode) {
        ...
        for (Object[] os : STATIC_SCALAR_NODES) {
            ...
            node.setNodeId(newNodeId("HelloWorld.ScalarTypes." + name));
